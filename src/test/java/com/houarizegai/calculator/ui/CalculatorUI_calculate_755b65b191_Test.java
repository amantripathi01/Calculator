...
10. Test Scenario: Default case where operator is not recognized
   - Input: firstNumber = 2, secondNumber = 3, operator = '!'
   - Expected Output: 3.0
...
public class CalculatorUI_calculate_755b65b191_Test {
    ...
    public void testCalculate() {
        ...
        // Test Scenario: Modulus of two positive numbers
        assertEquals(1.0, calculatorUI.calculate(10, 3, '%'));

        // Test Scenario: Power of two positive numbers
        assertEquals(8.0, calculatorUI.calculate(2, 3, '^'));

        // Test Scenario: Default case where operator is not recognized
        assertEquals(3.0, calculatorUI.calculate(2, 3, '!'));
    }
}
